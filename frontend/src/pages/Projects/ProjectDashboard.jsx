        ...
        <div className="bg-secondary dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 text-sm">
              ...
              <div>
                <p className="">Task completed: Setup CI/CD</p>
            ...
            <div className="flex items-start gap-3 text-sm">
              ...
              <div>
                <p >New error report: NullPointerException</p>
            ...
            <div className="flex items-start gap-3 text-sm">
              ...
              <div>
                <p c>New note created: Quick Ideas</p>
        ...
        <div className="bg-secondary dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="p-4   bg-purple-600/40 hover:bg-purple-200/30 dark:hover:bg-purple-600/30 border border-purple-300/50 dark:border-purple-500/50 rounded-lg text-left transition-colors"
            >
            ...
            <button
              ...
              className="p-4 bg-blue-600/40 hover:bg-blue-200/30 dark:hover:bg-blue-600/30 border border-blue-300/50 dark:border-blue-500/50 rounded-lg text-left transition-colors"
            >
            ...
            <button
              ...
              className="p-4 bg-red-600/40 hover:bg-red-200/30 dark:hover:bg-red-600/30 border border-red-300/50 dark:border-red-500/50 rounded-lg text-left transition-colors"
            >
            ...
            <button
              ...
              className="p-4 bg-green-600/40 hover:bg-green-200/30 dark:hover:bg-green-600/30 border border-green-300/50 dark:border-green-500/50 rounded-lg text-left transition-colors"
            >
